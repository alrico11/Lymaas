                    ...
                    <div id="useradd-2" class="card">
                        ...
                        <div class="card-footer">
                            <div class="col-md-12s">
                                {!! Form::submit(__('Save'), ['class' => 'btn btn-primary col-sm-2 float-end mb-3']) !!}
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
                                            ...
                                            <div class="col-md-12">
                                                @if (empty(auth()->user()->loginSecurity))
                                                    ...
                                                    <div class="row p-0">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            {{ Form::submit(__('Activate 2FA'), ['class' => 'btn btn-primary col-md-6']) }}
                                                ...
                                                @elseif(!auth()->user()->loginSecurity->google2fa_enable)
                                                    ...
                                                    <div class="col-md-12 text-end mt-2">
                                                        {{ Form::submit(__('Enable 2FA'), ['class' => 'btn btn-primary col-sm-2']) }}
                                                    </div>
                                                    {!! Form::close() !!}
                                                ...
                                                @elseif(auth()->user()->loginSecurity->google2fa_enable)
                                                    ...
                                                    <hr>
                                                    <div class="col-md-12 text-end">
                                                        {{ Form::submit(__('Disable 2FA'), ['class' => 'btn btn-danger col-sm-2']) }}
                                                    </div>
                                                    {!! Form::close() !!}
