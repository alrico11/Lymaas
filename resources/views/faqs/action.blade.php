<span>
    {{-- @can('edit-faqs') --}}
        <a class="btn btn-icon btn-primary btn-sm" href="faqs/{{ $faqs->id }}/edit" id="edit-user"
    ...
    @can('delete-faqs') --}}
        ...
        <a href="#" class="btn btn-sm small btn-danger show_confirm" id="delete-form-{{ $faqs->id }}"
